 ...
 */
class CRM_Ewayrecurring_Upgrader_Base {

  /**
   * @var CRM_Ewayrecurring_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Ewayrecurring_Upgrader(
  ...
  /**
   * CRM_Ewayrecurring_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
